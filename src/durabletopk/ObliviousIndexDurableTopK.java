/**
 * ObliviousIndexDurableTopK
 * ---------------------------
 * Implements data-oblivious index algorithm (DOS) from Section 4.1.
 *
 * Precomputes top-k lists for fixed values and uses them during query evaluation.
 *
 * Time Complexity:
 * - Indexing: O(kT)
 * - Query: O(n)
...
public class ObliviousIndexDurableTopK {
    private final Map<Integer, Map<Integer, List<Integer>>> topKAtTime;
